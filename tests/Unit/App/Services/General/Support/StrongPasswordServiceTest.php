...
final class StrongPasswordServiceTest extends BaseUnitTestCase
{
     ...
     */
    public function strong_password_can_get_tru_when_password_is_strong(string $password)
    {
     ...
     */
    public function strong_password_can_get_tru_when_password_is_weak(string $password)
    {
