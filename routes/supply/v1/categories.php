...
use App\Http\Controllers\Supply\Categories\ShowCategoryRankController;
...
Route::get('categories/{id}/rank', ShowCategoryRankController::class)->name('categories.rank');
